...
If RQ = vbYes Then
    ...
    x1.Workbooks.Open "D:\20230605\私募stt.xlsx" '指定 excel文档路径
...
For sheetIndex = 3 To 4              ' sheet的index
    With x1.Workbooks(1).Worksheets(sheetIndex)
        ...
        For rwIndex = 5 To 1000        'sheet 的行数
            ...
            Else        
                ...
                col.Code = .Cells(rwIndex, 4).Value '指定表字段
                col.Name = .Cells(rwIndex, 5).Value '指定列名
